...
def view_bookings_admin():
    ...
    for booking in booking_sql_list:
        booking_list.append({"roomName": booking.roomName, "userId": booking.userId, "startTime": str(booking.startDateTime.replace(tzinfo=None)), "endTime": str(booking.endDateTime.replace(tzinfo=None)),  "bookingPrice": str(booking.bookingPrice.replace(tzinfo=None))})
